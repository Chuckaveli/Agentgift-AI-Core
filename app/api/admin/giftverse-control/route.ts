...
// Make sure we never run this on Edge (service-role key must stay server-only)
...
// Create a fresh admin client per request (safe + simple)
...
export const POST = withAuth(async (request: NextRequest, context) => {
  ...
  try {
    ...
    // Verify admin access (adjust to your role model)
...
async function getUserBreakdown(
  ...
  // If you truly need a grouped count, consider a SQL function or a view.
