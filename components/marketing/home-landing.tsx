...
const interestOptions = [
  "Gaming","Fitness","Cooking","Tech","Books","Music","Wellness","Art","Pets","Travel","Fashion","Sports",
];

const relationships = [
  "Friend","Parent","Partner","Sibling","Coworker","Child","Grandparent","Boss","Teacher","Other",
];
